...
function UpdateFinal(Page, Opt)
{
    if ((Page == 4  && (Opt == 0 || Opt == 1)) || Page == 7) {
...
function UpdateText(Page, Opt) {
    ...
    if (Page > 1)
    {
        ...
        {
            alert(modifier)
            newContent.innerHTML = Storyline[Page - 1].Situation2[0];
            question.innerHTML = Storyline[Page].Content;
        }
        else
